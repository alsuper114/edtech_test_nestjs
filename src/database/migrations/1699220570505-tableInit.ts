...
export class TableInit1699220570505 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "lesson" ("id" SERIAL NOT NULL, "chapter" integer NOT NULL, "section" integer NOT NULL, "title" character varying, "videoLink" character varying, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, CONSTRAINT "PK_0ef25918f0237e68696dee455bd" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "lesson_users_user" ("lessonId" integer NOT NULL, "userId" integer NOT NULL, CONSTRAINT "PK_8b171f8975ffec63c490938a83c" PRIMARY KEY ("lessonId", "userId"))`);
        ...
        await queryRunner.query(`ALTER TABLE "lesson_users_user" ADD CONSTRAINT "FK_5fea17f3ea912b2cafbb1e65f60" FOREIGN KEY ("lessonId") REFERENCES "lesson"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "lesson_users_user" ADD CONSTRAINT "FK_9b085ea6f0570114685cedab8a3" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_9b085ea6f0570114685cedab8a"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_5fea17f3ea912b2cafbb1e65f6"`);
